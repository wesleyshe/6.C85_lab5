...
const projects = [
  ...
  {
    title: "Boss Mode: Command Center",
    year: 2024,
    image: "/image/7.jpg",
    description: "A boss-focused command center project about leading a chaotic team through deadlines and crises.",
  ...
  {
    title: "Arcade Strategy Analytics",
    year: 2025,
    image: "/image/8.jpg",
    description: "A video game analytics project tracking strategy, reaction time, and player decision patterns.",
  ...
  {
    title: "Operation Mallstorm",
    year: 2026,
    image: "/image/9.jpg",
    description: "A fictional operation planning a coordinated shopping mall invasion with a full plush army.",
